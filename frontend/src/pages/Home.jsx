                ...
                <div className="w-full h-full bg-white rounded-md shadow-lg border border-gray-300">
                    ...
                    <div>
                        <ul className='flex flex-col p-5 w-full justify-center space-y-2'>
                            <li onClick={() => setOptionBanner('Init')} className={`${optionBanner === 'Init' ? 'bg-gray-800 text-white shadow-lg cursor-pointer' : 'hover:bg-gray-400 hover:text-white text-gray-400 '} transition duration-500 ease-in-out p-2 cursor-pointer rounded-md`}><i className="fa-solid fa-house px-5"></i>Inicio</li>
